...
import { ChevronRight, MapPin, Calendar, Users, Star, Filter } from "lucide-react"
      ...
      <main className="flex-1">
        ...
        <section className="relative">
          ...
          <div className="container absolute inset-0 z-20 flex flex-col items-center justify-center text-center text-white">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Our Madagascar Tours</h1>
            <p className="mt-4 max-w-2xl text-lg">
              Explore our handcrafted experiences showcasing the best of Madagascar
            </p>
          </div>
        </section>
          ...
          <div className="container">
            <div className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold">Filter Tours</h2>
              </div>
                ...
                <div>
                  <Select>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="mid">Mid-range ($1000-$2000)</SelectItem>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Connect with local communities and learn about Madagascar's rich cultural heritage.
                  </p>
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-1">
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold mb-2">Photography Expedition</h3>
                  <p className="text-muted-foreground mb-4">
                    Capture Madagascar's stunning landscapes and unique wildlife with expert guidance.
                  </p>
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-1">
                      ...
                      <div className="flex items-center gap-1">
                        <Users className="h-4 w-4 text-muted-foreground" />
                        <span className="text-sm">Max 6</span>
                      </div>
                    </div>
                    <div className="flex items-center">
                      <Star className="h-4 w-4 fill-primary text-primary" />
              ...
              <Card className="overflow-hidden">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-2 text-muted-foreground mb-2">
                    <MapPin className="h-4 w-4" />
                    <span className="text-sm">Southern Madagascar</span>
                  </div>
                  <h3 className="text-xl font-bold mb-2">Southern Adventure Circuit</h3>
                  <p className="text-muted-foreground mb-4">
                    Explore the diverse landscapes of southern Madagascar from canyons to spiny forests.
                  </p>
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="mb-6 text-primary-foreground/90">
                  We specialize in creating custom tours tailored to your interests, timeline, and budget. Let us design
                  your perfect Madagascar adventure.
                </p>
